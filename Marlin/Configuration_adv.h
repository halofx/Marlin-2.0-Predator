...
#define DEFAULT_STEPPER_DEACTIVE_TIME 0   //   Don't disbale automatically, will drop on print.
 ...
 */
  ...
  #define Z2_HYBRID_THRESHOLD    120
  #define Z3_HYBRID_THRESHOLD    120
  #define Z4_HYBRID_THRESHOLD    120
