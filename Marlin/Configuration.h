...
#define CUSTOM_MACHINE_NAME "Predator r6"
 ...
 */
#define TEMP_SENSOR_0 5  // Using E3D spec thermistor
...
#define HEATER_0_MAXTEMP 300  //Using Phaetus Dragon Highflow
...
#define EXTRUDE_MAXLENGTH 700  // Longer for flying extruder
...
#define DEFAULT_ZJERK DEFAULT_XJERK  // Same on XYZ for Delta
...
#define XY_PROBE_FEEDRATE (50*60)  // 3000 mm/sec

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST HOMING_FEEDRATE_Z //  3000 mm/s

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 3)   // 1000 mm/s
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (50*60) }  // 3000mm/s, must match for Delta
